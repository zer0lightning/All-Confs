...
# ---------------------------------------------------
# Modded to Restart PC's Graphics Drivers by simulating the keyboard shortcut. 
# Manually to restart your graphics drivers, press Win+Ctrl+Shift+B on your keyboard. 
# Your screen will go black for a split second and you'll hear a beep. 
# Everything will then reappear just as it was before you pressed the hotkey.
